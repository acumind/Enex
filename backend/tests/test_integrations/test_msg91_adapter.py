"""Tests for MSG91Adapter: success, API error, missing key, HTTP error."""
...
@patch("app.integrations.sms.msg91_adapter.get_settings")
@patch("app.integrations.sms.msg91_adapter.httpx.AsyncClient")
async def test_send_otp_http_error(mock_client_cls: MagicMock, mock_settings: MagicMock) -> None:
    """httpx.HTTPError during send returns False."""
    mock_settings.return_value = MagicMock(
        MSG91_AUTH_KEY="test_key",
        MSG91_TEMPLATE_ID="tpl_123",
        MSG91_SENDER_ID="ENEXIN",
